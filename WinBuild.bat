...
nmake RTL=MTd NET_PROVIDER=WININET CRYPTO_PROVIDER=CRYPTOAPI OPENSSL_CA_FILE=C:\Users\Taavi\Documents\GuardTime\ksi-c-api\test\resource\tlv\mock.crt test
pause
