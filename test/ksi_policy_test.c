...
static void TestSignatureVerify_Internal(CuTest* tc) {
	int res;
	KSI_Signature *sig = NULL;
	KSI_PolicyVerificationResult *result = NULL;
	KSI_RuleVerificationResult expected = {
...
static void TestSignatureVerify_DocHash_NoHash(CuTest* tc) {
	int res;
	KSI_Signature *sig = NULL;
	KSI_PolicyVerificationResult *result = NULL;
#define TEST_SIGNATURE_FILE "resource/tlv/ok-sig-2014-04-30.1.ksig"
	...
	res = KSI_SignatureVerify_documentHash(sig, ctx, NULL, &result);
	CuAssert(tc, "Signature verification failed", res == KSI_INVALID_FORMAT);
...
static void TestSignatureVerify_DocHash(CuTest* tc) {
	int res;
	KSI_Signature *sig = NULL;
...
#define TEST_SIGNATURE_FILE "resource/tlv/ok-sig-2014-04-30.1.ksig"
	...
	CuAssert(tc, "Unable to get document hash.", res == KSI_OK && sig != NULL);

	res = KSI_SignatureVerify_documentHash(sig, ctx, docHash, &result);
	CuAssert(tc, "Signature verification failed", res == KSI_OK);
	CuAssert(tc, "Unexpected verification result", ResultsMatch(&expected, &result->finalResult));
...
static void TestSignatureVerify_PublicationBasedWithUserPub(CuTest* tc) {
	int res;
	KSI_Signature *sig = NULL;
	KSI_Signature *extSig = NULL;
	KSI_PublicationRecord *tempRec = NULL;
...
#define TEST_EXT_RESPONSE_FILE "resource/tlv/ok-sig-2014-04-30.1-extend_response.tlv"
	...
	res = KSI_SignatureVerify_userProvidedPublicationBased(sig, ctx, pubData, 1, &result);
	CuAssert(tc, "Signature verification failed", res == KSI_OK);
	CuAssert(tc, "Unexpected verification result", ResultsMatch(&expected, &result->finalResult));
...
static void TestSignatureVerify_PublicationBasedWithPubFile(CuTest* tc) {
	int res;
	KSI_Signature *sig = NULL;
	KSI_PublicationsFile *publicationsFile = NULL;
	KSI_PolicyVerificationResult *result = NULL;
...
#define TEST_EXT_RESPONSE_FILE "resource/tlv/ok-sig-2014-04-30.1-extend_response.tlv"
	...
	res = KSI_SignatureVerify_publicationsFileBased(sig, ctx, publicationsFile, 1, &result);
	CuAssert(tc, "Signature verification failed", res == KSI_OK);
	CuAssert(tc, "Unexpected verification result", ResultsMatch(&expected, &result->finalResult));
...
static void TestSignatureVerify_PublicationBasedWithPubFile_SigWithPubRec(CuTest* tc) {
	int res;
	KSI_Signature *sig = NULL;
	KSI_PublicationsFile *publicationsFile = NULL;
	KSI_PolicyVerificationResult *result = NULL;
...
static void TestSignatureVerify_CalendarBased(CuTest* tc) {
	int res;
	KSI_Signature *sig = NULL;
	KSI_PolicyVerificationResult *result = NULL;
	KSI_RuleVerificationResult expected = {
...
CuSuite* KSITest_Policy_getSuite(void) {
	...
	/*Verification policy helper function utin tests */
	SUITE_ADD_TEST(suite, TestSignatureVerify_InternalConsistency);
	SUITE_ADD_TEST(suite, TestSignatureVerify_Internal);
	SUITE_ADD_TEST(suite, TestSignatureVerify_DocHash_NoHash);
	SUITE_ADD_TEST(suite, TestSignatureVerify_DocHash);
	SUITE_ADD_TEST(suite, TestSignatureVerify_PublicationBasedWithUserPub);
	SUITE_ADD_TEST(suite, TestSignatureVerify_PublicationBasedWithUserPub_ExtNotPermitted);
	SUITE_ADD_TEST(suite, TestSignatureVerify_PublicationBasedWithPubFile);
	SUITE_ADD_TEST(suite, TestSignatureVerify_PublicationBasedWithPubFile_SigWithPubRec);
